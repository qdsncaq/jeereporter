 ...
 * @version 2016-03-17
 */
public class OmsOrderReport extends DataEntity<OmsOrderReport> {
	...
	public OmsOrderReport() {
		super();
	}

	public OmsOrderReport(String id){
		super(id);
	}
	...
	@ExcelField(title="交易备注", align=2, sort=115)
	...
	@ExcelField(title="订单金额", align=2, sort=190)
    ...
    @ExcelField(title="酒店名称", align=2, sort=250)
    ...
    @ExcelField(title="销售名称", align=2, sort=280)
    ...
    @ExcelField(title="件数", align=2, sort=170)
   ...
   // @ExcelField(title="成交金额", align=2, sort=80)
	...
	@ExcelField(title="销售电话", align=2, sort=290)
	...
	@ExcelField(title="商品名称", align=2, sort=300)
	...
	@ExcelField(title="用户id", align=2, sort=260)
	...
	@ExcelField(title="用户名称", align=2, sort=270)
	...
	@ExcelField(title="酒店id", align=2, sort=240)
	...
	@ExcelField(title="SKU编码", align=2, sort=200)
	...
	@ExcelField(title="商品类别", align=2, sort=210)
	...
	@ExcelField(title="商品单价", align=2, sort=160)
	...
	@ExcelField(title="商品总价", align=2, sort=180)
	...
	public void setComtotoleFee(String comtotoleFee) {
		  BigDecimal bd = new BigDecimal(comtotoleFee);
	  this.comtotoleFee = bd.divide(divisor, 2, BigDecimal.ROUND_HALF_UP).toPlainString();
	}
	...
	public void setRemarks(String remarks) {
	 ...
	 @ExcelField(title="预发货时间", align=2, sort=115)
	...
	@ExcelField(title="买家会员名", align=2, sort=230)
	...
	public void setEndUpdateTime(String endUpdateTime) {
	 ...
	 @ExcelField(title="运单号", align=2, sort=155)
