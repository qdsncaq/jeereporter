 ...
 */
package com.thinkgem.psb.psbbill.entity;
 ...
 * @version 2016-04-21
 */
public class SettlementPsbhotelbill extends DataEntity<SettlementPsbhotelbill> {
	...
	private Date billstarttime;		// 统计开始时间
	private Date billendtime;		// 统计结束时间
	...
	private BigDecimal beginFee;		// 开始 本年年费
	private BigDecimal endFee;		// 结束 本年年费
	private Integer beginOnlinedays;		// 开始 HMS有效天数（账期已统计天数）
	private Integer endOnlinedays;		// 结束 HMS有效天数（账期已统计天数）
	private BigDecimal beginAmount;		// 开始 结算金额(预付给psb金额)
	private BigDecimal endAmount;		// 结束 结算金额(预付给psb金额)
	private BigDecimal beginRecoveramount;		// 开始 应收金额
	private BigDecimal endRecoveramount;		// 结束 应收金额
	private Date beginCreatetime;		// 开始 创建时间
	private Date endCreatetime;		// 结束 创建时间
	private Date beginUpdatetime;		// 开始 更新时间
	private Date endUpdatetime;		// 结束 更新时间
	private Date beginBillstarttime;		// 开始 统计开始时间
	private Date endBillstarttime;		// 结束 统计开始时间
	private Date beginBillendtime;		// 开始 统计结束时间
	private Date endBillendtime;		// 结束 统计结束时间
	
	private Integer billtype;		// 账单状态1:新上线酒店 
	private String billtypedesc; 	// 账单状态描述
	
	public SettlementPsbhotelbill() {
		super();
	}

	public SettlementPsbhotelbill(String id){
		super(id);
	}

	@Length(min=1, max=11, message="psbid长度必须介于 1 和 11 之间")
	...
	@Length(min=0, max=500, message="酒店名称(PMS)长度必须介于 0 和 500 之间")
	...
	@Length(min=0, max=200, message="省长度必须介于 0 和 200 之间")
	...
	@Length(min=0, max=200, message="市长度必须介于 0 和 200 之间")
	...
	@Length(min=0, max=200, message="区长度必须介于 0 和 200 之间")
	...
	@Length(min=0, max=11, message="酒店房间数长度必须介于 0 和 11 之间")
	...
	@Length(min=0, max=11, message="当前酒店HMS在线状态(1,在线/2,离线)长度必须介于 0 和 11 之间")
	...
	@Length(min=0, max=11, message="HMS有效天数（账期已统计天数）长度必须介于 0 和 11 之间")
	...
	public BigDecimal getBeginRecoveramount() {
		return beginRecoveramount;
	}

	public void setBeginRecoveramount(BigDecimal beginRecoveramount) {
		this.beginRecoveramount = beginRecoveramount;
	}
	
	public BigDecimal getEndRecoveramount() {
		return endRecoveramount;
	}

	public void setEndRecoveramount(BigDecimal endRecoveramount) {
	...
	public Date getBeginBillstarttime() {
		return beginBillstarttime;
	}

	public void setBeginBillstarttime(Date beginBillstarttime) {
		this.beginBillstarttime = beginBillstarttime;
	}
	
	public Date getEndBillstarttime() {
		return endBillstarttime;
	}

	public void setEndBillstarttime(Date endBillstarttime) {
		this.endBillstarttime = endBillstarttime;
	}
		
	public Date getBeginBillendtime() {
		return beginBillendtime;
	}

	public void setBeginBillendtime(Date beginBillendtime) {
		this.beginBillendtime = beginBillendtime;
	}
	
	public Date getEndBillendtime() {
		return endBillendtime;
	}

	public void setEndBillendtime(Date endBillendtime) {
		this.endBillendtime = endBillendtime;
	}
