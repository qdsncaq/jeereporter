...
/**
 * CRM 分销拜访记录Entity 设置导出excel,重写导出规则
 * @author 段文昌
 * @version 2016-03-14
 */
public class RfCrmWashVisitRecord extends RfCrmVisitRecord implements Serializable {
	...
	public RfCrmWashVisitRecord() {
		super();
	}

	public RfCrmWashVisitRecord(String id){
		super(id);
	}
...
//	@ExcelField(title = "是否签约", align = 2, sort = 75)
	...
	@ExcelField(title = "GPS参考地址", align = 2, sort = 150)
