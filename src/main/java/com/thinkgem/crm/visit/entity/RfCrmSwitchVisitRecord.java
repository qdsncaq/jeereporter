 ...
 * @version 2016-03-14
 */
public class RfCrmSwitchVisitRecord extends RfCrmVisitRecord implements Serializable {
	...
	public RfCrmSwitchVisitRecord() {
		super();
	}

	public RfCrmSwitchVisitRecord(String id){
		super(id);
	}
