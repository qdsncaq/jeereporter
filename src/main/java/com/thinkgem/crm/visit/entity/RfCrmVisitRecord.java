 ...
 * @version 2016-03-14
 */
public class RfCrmVisitRecord extends DataEntity<RfCrmVisitRecord> {

	/**
	 * 分销类查询列表
	 */
	public static final String VISIT_SWITCH_TYPE = "switch";
	/**
	 * 采销类查询列表
	 */
	public static final String VISIT_MARKETING_TYPE = "marketing";
	/**
	 * 洗涤类查询列表
	 */
	public static final String VISIT_WASH_TYPE = "wash";
    ...
    private List<String> visitUsers;
	...
	private Date visitTimeEnd;		// 结束拜访时间
	...
	private String signFailure;		//签约失败原因

	private String washIntention;		// 洗涤意向
	private String washIntentionName;		// 洗涤意向名称
	private String washSign;			//是否洗涤签约
	private String washSignName;			//是否洗涤签约名称
	private Date washSignDate;			//洗涤签约日期
	private Date washSignDateEnd;			//洗涤签约日期筛选
	...
	public RfCrmVisitRecord() {
		super();
	}

	public RfCrmVisitRecord(String id){
		super(id);
	}
	...
	public void setVisitUser(String visitUser) {
        ...
        if (StringUtils.isNoneBlank(visitUser)) {
            this.visitUsers = Arrays.asList(visitUser.split(","));
        } else {
            this.visitUsers = null;
        }
	...
	public String getWashIntention() {
		return washIntention;
	}

	public void setWashIntention(String washIntention) {
		this.washIntention = washIntention;
	}
	@ExcelField(title = "洗涤意向", align = 2, sort = 180)
	public String getWashIntentionName() {
		if("T".equals(this.washIntention)){
			this.washIntentionName = "有意向";
		} else if("F".equals(this.washIntention)){
			this.washIntentionName = "无意向";
		}
		return washIntentionName;
	}

	public void setWashIntentionName(String washIntentionName) {
		this.washIntentionName = washIntentionName;
	}

	public String getWashSign() {
		return washSign;
	}

	public void setWashSign(String washSign) {
		this.washSign = washSign;
	}
	@ExcelField(title = "洗涤签约", align = 2, sort = 170)
	public String getWashSignName() {
		if("T".equals(this.washSign)){
			this.washSignName = "是";
		} else if("F".equals(this.washSign)){
			this.washSignName = "否";
		}
		return washSignName;
	}

	public void setWashSignName(String washSignName) {
		this.washSignName = washSignName;
	}
    ...
    public List<String> getVisitUsers() {
        return visitUsers;
    }

    public void setVisitUsers(String visitUsers) {
        if (StringUtils.isBlank(visitUsers)) {
            this.visitUsers = null;
        } else {
            this.visitUsers = Arrays.asList(visitUsers.split(","));
        }
    }
	@ExcelField(title = "洗涤签约日期", align = 2, dataFormat = "yyyy-MM-dd", sort = 200)
	public Date getWashSignDate() {
		return washSignDate;
	}

	public void setWashSignDate(Date washSignDate) {
		this.washSignDate = washSignDate;
	}

	public Date getWashSignDateEnd() {
		return washSignDateEnd;
	}

	public void setWashSignDateEnd(Date washSignDateEnd) {
		this.washSignDateEnd = washSignDateEnd;
	}

	@ExcelField(title = "签约失败原因", align = 2, sort = 210)
	public String getSignFailure() {
		return signFailure;
	}

	public void setSignFailure(String signFailure) {
	...
	public String toString() {
		return "RfCrmVisitRecord{" +
				"visitHotelId=" + visitHotelId +
				", visitHotelName='" + visitHotelName + '\'' +
				", visitType='" + visitType + '\'' +
				", visitTypeName='" + visitTypeName + '\'' +
				", visitWay='" + visitWay + '\'' +
				", visitWayName='" + visitWayName + '\'' +
				", visitHotelIntention='" + visitHotelIntention + '\'' +
				", hotelContacts='" + hotelContacts + '\'' +
				", hotelContactsName='" + hotelContactsName + '\'' +
				", visitUser='" + visitUser + '\'' +
				...
				", sampleGrant='" + sampleGrant + '\'' +
				", sampleGrantName='" + sampleGrantName + '\'' +
				", purchaseIntention='" + purchaseIntention + '\'' +
				", purchaseIntentionName='" + purchaseIntentionName + '\'' +
				", isSign='" + isSign + '\'' +
				", isSignName='" + isSignName + '\'' +
				", signFailure='" + signFailure + '\'' +
				", washIntention='" + washIntention + '\'' +
				", washIntentionName='" + washIntentionName + '\'' +
				", washSign='" + washSign + '\'' +
				", washSignName='" + washSignName + '\'' +
				", washSignDate=" + washSignDate +
				", washSignDateEnd=" + washSignDateEnd +
				", provCode='" + provCode + '\'' +
				", provName='" + provName + '\'' +
				", cityCode='" + cityCode + '\'' +
				", cityName='" + cityName + '\'' +
				...
				", zhi='" + zhi + '\'' +
				", lajidai='" + lajidai + '\'' +
				", queryVisitType='" + queryVisitType + '\'' +
				", pics='" + pics + '\'' +
				", picArray=" + Arrays.toString(picArray) +
				", longitude=" + longitude +
				", latitude=" + latitude +
