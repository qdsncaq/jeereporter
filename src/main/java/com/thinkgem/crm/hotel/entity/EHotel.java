 ...
 * @version 2016-03-28
 */
public class EHotel extends DataEntity<EHotel> {
	...
	private String operateName; 	//最后审核人名称
	private Date operateTime; 	//最后审核时间
	private Date beginOperateTime; 	//开始 最后审核时间
	private Date endOperateTime; 	//结束 最后审核时间

	public EHotel() {
		super();
	}

	public EHotel(String id){
		super(id);
	}

	@Length(min=1, max=50, message="hotelname长度必须介于 1 和 50 之间")
    @ExcelField(title = "酒店名称", align = 2, sort = 50)
    ...
    @ExcelField(title = "前台电话", align = 2, sort = 70)
    ...
    @ExcelField(title = "老板电话", align = 2, sort = 90)
    ...
    @ExcelField(title = "老板名字", align = 2, sort = 80)
    ...
    @ExcelField(title = "市", align = 2, sort = 30)
    ...
    @ExcelField(title = "区", align = 2, sort = 40)
    ...
    @ExcelField(title = "省", align = 2, sort = 20)
    ...
    @ExcelField(title = "销售电话", align = 2, sort = 110)
    ...
    @ExcelField(title = "销售名字", align = 2, sort = 100)
    ...
    @ExcelField(title = "审核状态", align = 2, sort = 120, dictType="hotelCheckState")
