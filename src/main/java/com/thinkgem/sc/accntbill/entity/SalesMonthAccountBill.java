...
// * @version 2016-03-21
// */
//public class SalesMonthAccountBill extends DataEntity<SalesMonthAccountBill> {
//	
...
//	
//	public SalesMonthAccountBill() {
//		super();
//	}
//
//	public SalesMonthAccountBill(String id){
//		super(id);
//	}
//	
...
//	}
//	
//	@ExcelField(title="订单总额", type=1, align=2, sort=40)
...
//	}
//	
//	@ExcelField(title="销售奖金", type=1, align=2, sort=45)
...
//	@ExcelField(title="客户名称", type=1, align=2, sort=25)
...
//	}
//
//	@ExcelField(title="财务状态", type=1, align=2, sort=35)
...
//	}
//
//	@ExcelField(title="业务类型", type=1, align=2, sort=35)
