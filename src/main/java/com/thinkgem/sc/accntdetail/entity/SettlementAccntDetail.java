 ...
 * @version 2016-03-18
 */
public class SettlementAccntDetail extends DataEntity<SettlementAccntDetail> {
     ...
     * 账单明细滚账之前的账户余额
     */
    private BigDecimal balanceonbeforeupdate;
    
    /**
     * 账单明细滚账之后的账户余额(即历史余额)
     */
    private BigDecimal balanceonafterupdate;
    
    /**
     * 处理标识: 如果滚账之后对余额做过处理标识为1，否则标识为2
     */
	...
	public SettlementAccntDetail() {
		super();
	}

	public SettlementAccntDetail(String id){
		super(id);
	}
	...
	@ExcelField(title="充值优惠金额", type=1, align=2, sort=130)
    ...
    public void setBonusproportion(BigDecimal bonusproportion) {
    ...
    public BigDecimal getBalanceonbeforeupdate() {
        return balanceonbeforeupdate;
    }

    public void setBalanceonbeforeupdate(BigDecimal balanceonbeforeupdate) {
        this.balanceonbeforeupdate = balanceonbeforeupdate;
    }

    public BigDecimal getBalanceonafterupdate() {
        return balanceonafterupdate;
    }

    public void setBalanceonafterupdate(BigDecimal balanceonafterupdate) {
        this.balanceonafterupdate = balanceonafterupdate;
    }
