	...
	<script type="text/javascript">
		...
		$(function(){
			$("#btnSubmit").click(function(){ 
				...
				$.post('${ctx }/scadmin/washdetail/update', data, function(data){
					// alert(data);return false;
					if(data > 0){
						layer.msg("修改完成！");
						setTimeout("window.location.reload('washDetailList.jsp')",1000);
					} else {
...
<body>
	...
	<div>
		<form:form id="searchForm" action="${ctx}/scadmin/washdetail/list" method="post" class="breadcrumb form-search">
			...
			<ul class="ul-form">
				<div>
			        ...
			        <input type="hidden" id="id" name="id" value="${id }">
			                   订单ID:<input type="text" name="orderid" value="${params.orderid }" style="width:130px;margin-right:15px;" > 
			                   酒店ID:<input type="text" name="hotelid" value="${params.hotelid }" style="width:130px;margin-right:15px;" > 
			                   酒店名称:<input type="text" name="hotelname" value="${params.hotelname }" style="width:130px;margin-right:15px;" > 
