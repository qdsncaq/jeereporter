...
<body>
    <form:form id="searchForm" action="${ctx}/scadmin/washbill/" method="post" class="breadcrumb form-search">
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed">
        ...
        <c:forEach items="${message.result }" var="accountLedger">
            <tr>
                <td>${accountLedger.id}</td>
                <td>${accountLedger.accountid}</td>
                <td>{item.orderid}</td>
                <td>{item.hotelid}</td>
