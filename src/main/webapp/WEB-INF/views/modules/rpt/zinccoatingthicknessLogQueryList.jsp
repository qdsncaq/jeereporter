...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/rpt/zinccoatingthicknessLog/queryList">锌层测厚日志列表</a></li>
	...
	<form:form id="searchForm" modelAttribute="zinccoatingthicknessLog" action="${ctx}/rpt/zinccoatingthicknessLog/queryList" method="post" class="breadcrumb form-search">
