...
<head>
    ...
    <script type="text/javascript">
         ...
         * 导出销售提现申请记录
         */
        function exportexcelSaler(){
            $("#searchForm").attr("action",ctx+"/accntwithdraw/settlementAccountWithdrawcash/exportexcelSaler");
            $("#searchForm").submit();
            return false;
        }
        ...
        function page(n,s){
            $("#pageNo").val(n);
            $("#pageSize").val(s);
            $("#searchForm").attr("action",ctx+"/accntwithdraw/settlementAccountWithdrawcash/listOfSaler");
            $("#searchForm").submit();
            return false;
        }
    </script>
...
<body>
    <ul class="nav nav-tabs">
        <li class="active"><a href="${ctx}/accntwithdraw/settlementAccountWithdrawcash/listOfSaler">销售提现申请列表</a></li>
    </ul>
    <form:form id="searchForm" modelAttribute="settlementAccountWithdrawcash" action="${ctx}/accntwithdraw/settlementAccountWithdrawcash/listOfSaler" method="post" class="breadcrumb form-search">
        ...
        <ul class="ul-form">
            ...
            <li class="btns"><input class="btn btn-primary" type="button" onclick="exportexcelSaler()" value="导出excel"/></li>
<%--             
            <shiro:hasRole name="SALER_TXSH_OPERATOR">
                <li class="btns"><input id="ThroughAuditOperator" class="btn btn-primary" type="button" onclick="throughaudit('SALER_TXSH_OPERATOR')" value="运营确认"/></li>
                <li class="btns"><input id="ThroughAuditnoOperator" class="btn btn-primary" type="button" onclick="throughauditNo('SALER_TXSH_OPERATOR')" value="运营驳回"/></li>
            </shiro:hasRole>
            <shiro:hasRole name="SALER_TXSH_HR">
                <li class="btns"><input id="ThroughAuditHR" class="btn btn-primary" type="button" onclick="throughaudit('SALER_TXSH_HR')" value="人事确认"/></li>
                <li class="btns"><input id="ThroughAuditnoHR" class="btn btn-primary" type="button" onclick="throughauditNo('SALER_TXSH_HR')" value="人事驳回"/></li>
            </shiro:hasRole>
            <shiro:hasRole name="SALER_TXSH_FI">
                <li class="btns"><input id="ThroughAuditFI" class="btn btn-primary" type="button" onclick="throughaudit('SALER_TXSH_FI')" value="财务打款"/></li>
                <li class="btns"><input id="ThroughAuditnoFI" class="btn btn-primary" type="button" onclick="throughauditNo('SALER_TXSH_FI')" value="财务驳回"/></li>
            </shiro:hasRole>
 --%>            
            <li class="clearfix"></li>
        </ul>
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed">
        <thead>
            <tr>
                ...
                <th>支行</th>
                <th>提现状态</th>
                <shiro:hasAnyRoles name="SALER_TXSH_OPERATOR,SALER_TXSH_HR,SALER_TXSH_FI">
                <th>提现审核</th>
                </shiro:hasAnyRoles>
            </tr>
        </thead>
            ...
            <tr>
                ...
                <td nowrap>
                    <c:choose>
                        ...
                        <shiro:hasRole name="SALER_TXSH_OPERATOR">
                          <a href="javascript:;" confirmaction="${ctx}/accntwithdraw/settlementAccountWithdrawcash/operatorConfirm?id=${settlementAccountWithdrawcash.id}" onclick="return confirmx('您要确认该提现申请吗？', $(this).attr('confirmaction'))">运营确认</a>
                        | <a href="javascript:;" confirmaction="${ctx}/accntwithdraw/settlementAccountWithdrawcash/operatorCancel?id=${settlementAccountWithdrawcash.id}" onclick="return confirmx('您要驳回该提现申请吗？', $(this).attr('confirmaction'))">运营驳回</a>
                        </shiro:hasRole>
                        <shiro:lacksRole name="SALER_TXSH_OPERATOR"><font color="#ff0000">【等待运营审核】</font></shiro:lacksRole>
                        </c:when>
                        <c:when test="${settlementAccountWithdrawcash.status == 10}">
                        <shiro:hasRole name="SALER_TXSH_HR">
                          <a href="javascript:;" confirmaction="${ctx}/accntwithdraw/settlementAccountWithdrawcash/hrConfirm?id=${settlementAccountWithdrawcash.id}" onclick="return confirmx('您要确认该提现申请吗？', $(this).attr('confirmaction'))">人事确认</a>
                        | <a href="javascript:;" confirmaction="${ctx}/accntwithdraw/settlementAccountWithdrawcash/hrCancel?id=${settlementAccountWithdrawcash.id}" onclick="return confirmx('您要驳回该提现申请吗？', $(this).attr('confirmaction'))">人事驳回</a>
                        </shiro:hasRole>
                        <shiro:lacksRole name="SALER_TXSH_HR"><font color="#ff0000">【等待人事审核】</font></shiro:lacksRole>
                        </c:when>
                        <c:when test="${settlementAccountWithdrawcash.status == 12 || settlementAccountWithdrawcash.status == 2}">
                        <shiro:hasRole name="SALER_TXSH_FI">
                          <a href="javascript:;" confirmaction="${ctx}/accntwithdraw/settlementAccountWithdrawcash/fiConfirm?id=${settlementAccountWithdrawcash.id}" onclick="return confirmx('您确定要打款吗？', $(this).attr('confirmaction'))">财务打款</a>
                        | <a href="javascript:;" confirmaction="${ctx}/accntwithdraw/settlementAccountWithdrawcash/fiCancel?id=${settlementAccountWithdrawcash.id}" onclick="return confirmx('您要驳回该提现申请吗？', $(this).attr('confirmaction'))">财务驳回</a>
                        </shiro:hasRole>
                        <shiro:lacksRole name="SALER_TXSH_FI"><font color="#ff0000">【等待财务审核】</font></shiro:lacksRole>
                        </c:when>
