...
<head>
	...
	<script type="text/javascript">
		...
		function exportexcel(){
			$("#searchForm").attr("action",ctx+"/accntbill/settlementAccntBill/exportexcel");
			$("#searchForm").submit();
		    return false;
        }
		// 结算===收款
		...
		function page(n,s){
			$("#pageNo").val(n);
			$("#pageSize").val(s);
			$("#searchForm").attr("action",ctx+"/accntbill/settlementAccntBill/list");
			$("#searchForm").submit();
        	return false;
        }
	</script>
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/accntbill/settlementAccntBill/list">旅行社周账单列表</a></li>
		<shiro:hasPermission name="accntbill:settlementAccntBill:edit"><li><a href="${ctx}/accntbill/settlementAccntBill/form">旅行社周账单添加</a></li></shiro:hasPermission>
	</ul>
	...
	<form:form id="searchForm" modelAttribute="settlementAccntBill" action="${ctx}/accntbill/settlementAccntBill/list" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="settlementAccntBill">
			<tr>
                ...
                <td>
                	<a href="${ctx}/accntbill/settlementAccntBill/form?id=${settlementAccntBill.id}">
				...
				<%-- <td>
					${fns:getDictLabel(settlementAccntBill.sctype, 'SettlementTypeEnums', '')}
				</td> --%>
				<td>
				...
				<td>
	            	<a href="${ctx }/accntdetail/settlementAccntDetail/finddetails?accountid=${settlementAccntBill.accountid}&accountrole=${settlementAccntBill.accountrole}&beginLeftDate=<fmt:formatDate value="${settlementAccntBill.beginDate}" pattern="yyyy-MM-dd HH:mm:ss"/>&endLeftDate=<fmt:formatDate value="${settlementAccntBill.endDate}" pattern="yyyy-MM-dd HH:mm:ss"/>&biztype=${settlementAccntBill.biztype}">明细</a>
