		...
		$(function(){
			$("#savebtnSubmit").click(function(){ 
				...
				$.post('${ctx }/accntdetail/settlementAccntDetail/modify', data, function(data){
					...
					alertx(data + '该单对应销售、酒店是否都进行调整.');setTimeout("window.location.reload('tripWeekDerailList.jsp')",1000);return false;
				}) 
			 });
		}) 
	</script>
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="javascript:;"onclick="query()">账单流水列表</a></li>
